...
import com.example.musicplayer.databinding.FragmentDialogSongInforBinding
...
class DialogSongInforFragment : BottomSheetDialogFragment() {
    ...
    private lateinit var binding : FragmentDialogSongInforBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentDialogSongInforBinding.inflate(inflater, container, false)
        return binding.root
    }
